...
A Solicitação de Serviço é aberta pelo Gestor de Negócio e encaminhada para análise da Coordenação de Tecnologia e Comunicação. 
O Auditor de Negócio responsável pela área registra a abertura da demanda/projeto na Ferramenta de Gestão de Demandas.
